...
public class DelayConsumerQueue extends DelayBaseQueue {
    ...
    public DelayConsumerQueue(DelayQueuePart delayQueuePart, String relTopic) {
        ...
        this.listenStartThreadPool = new ThreadPoolExecutor(1, 1, 60, TimeUnit.SECONDS,
    ...
    private void destroy(ThreadPoolExecutor executeTaskThreadPool) {
        try {
            if (Objects.nonNull(executeTaskThreadPool)) {
                executeTaskThreadPool.shutdown();
            }
        } catch (Exception e) {
